  ...
  def fvap_csv(election)
    ...
    @rcsv = 
      [ [ "Normal" , '' , '' , '' , '' ],
        ...
        [ "15. How many absentee ballots were received after the ballot receipt deadline?" ,
        ...
        [ "    2. Number of applications from domestic IP addresses" , 'N/A' , 'N/A' , 'N/A' , 'N/A' ],
        [ "    3. Number of applications from foreign IP addresses" , 'N/A' , 'N/A' , 'N/A' , 'N/A' ],
...
#    TOT: [total]
  ...
  def voter_fvap_qs(election)
    @r5qs = [["Header","Normal","Virginia,Uniformed Service,Overseas Civilians,Non UOCAVA,Total"],
             ...
             ["N/A","2.","Number of applications from domestic IP addresses"],
             ["N/A","3.","Number of applications from foreign IP addresses"],
